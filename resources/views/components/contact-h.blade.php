                    ...
                    <div class="flex justify-center">
                        <div class="w-full">
                            <div class="hero-cap text-center ">
                                <h1 class="text-3xl font-bold text-orange-500"> {{$item->name}}</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="p-6 bg-gray-800 rounded-lg shadow-lg">
            ...
            <ul class="space-y-4 text-gray-300">
                <li><i class="fas fa-map-marker-alt text-orange-500 mr-3"></i> {{$item->content}}</li>
                <li><i class="fas fa-envelope text-orange-500 mr-3"></i> {{$item->email}}</li>
                <li><i class="fas fa-phone text-orange-500 mr-3"></i> (84){{$item->phone}}</li>
                <li><i class="fas fa-clock text-orange-500 mr-3"></i> {{$item->timeline}}</li>
            </ul>
        </div>
